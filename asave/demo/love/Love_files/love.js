(function(window){
    ...
    Seed.prototype = {
        ...
        drawHeart: function() {
            let ctx = this.tree.ctx, heart = this.heart;
            let point = heart.point, color = heart.color,
                scale = heart.scale;
            ctx.save()
            ctx.fillStyle = color;
        ...
        drawCirle: function() {
            let ctx = this.tree.ctx, cirle = this.cirle;
            let point = cirle.point, color = cirle.color,
        ...
        clear: function() {
            let ctx = this.tree.ctx, cirle = this.cirle;
            let point = cirle.point, scale = cirle.scale, radius = 26;
    ...
    Footer.prototype = {
        draw: function() {
            let ctx = this.tree.ctx, point = this.point;
    ...
    Tree.prototype = {
        ...
        flower: function(num) {
            let s = this, blooms = s.bloomsCache.splice(0, num)
            for (let i = 0; i < blooms.length; i++) {
                s.addBloom(blooms[i])
            }
            blooms = s.blooms;
    ...
    Bloom.prototype = {
        ...
        draw: function() {
            let s = this, ctx = s.tree.ctx, figure = s.figure;
            ctx.save()
        ...
        jump: function() {
            let s = this, height = s.tree.height;
